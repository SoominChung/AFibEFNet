...
class ResNet(nn.Module):
    ...
    # layer & block default = for ResNet50
    def __init__(self,layers=[3, 4, 6, 3],what_block='bottleneck', num_classes=1, feature_num=0,zero_init_residual=True):
        super(ResNet, self).__init__()
        self.inplanes = 32 
    
        if what_block == 'bottleneck':
            block = Bottleneck
        elif what_block == 'basicblock':
            block = BasicBlock
        
        self.conv1 = nn.Conv1d(8, 32, kernel_size=10, stride=1, padding=1, bias=False)
        ...
        self.fc = nn.Linear((256 * block.expansion)+feature_num, num_classes)
